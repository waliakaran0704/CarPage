...
namespace FinalProject {
    ...
    public partial class dsCustomer : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CustomerRow AddCustomerRow(string Name, string Username, string Password, string Phone, string Address, int Age) {
...
namespace FinalProject.dsCustomerTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customer] ([Name], [Username], [Password], [Phone], [Address]," +
                " [Age]) VALUES (@Name, @Username, @Password, @Phone, @Address, @Age)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Customer] SET [Name] = @Name, [Username] = @Username, [Password] = " +
                "@Password, [Phone] = @Phone, [Address] = @Address, [Age] = @Age WHERE (([Id] = @" +
                "Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Username, Password, Phone, Address, Age FROM dbo.Customer";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Name, Username, Password, Phone, Address, Age FROM dbo.Customer \r\nWHER" +
                "E Username = @username;";
            ...
            this._commandCollection[2].CommandText = "UPDATE       Customer\r\nSET                Name = @Name, Password = @Password, Pho" +
                "ne = @Phone, Address = @Address, Age = @Age\r\nWHERE        (Username = @username)" +
                ";  ";
        ...
        public virtual int FillByUsername(dsCustomer.CustomerDataTable dataTable, string username) {
        ...
        public virtual dsCustomer.CustomerDataTable GetDataByUsername(string username) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
        ...
        public virtual int Insert(string Name, string Username, string Password, string Phone, string Address, global::System.Nullable<int> Age) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Username, string Password, string Phone, string Address, global::System.Nullable<int> Age, int Original_Id) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        public virtual int UpdateCustomerInfo(string Name, string Password, string Phone, string Address, global::System.Nullable<int> Age, string username) {
