...
namespace FinalProject {
    ...
    public partial class Cars : global::System.Data.DataSet {
        ...
        public partial class CarDataTable : global::System.Data.TypedTableBase<CarRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CarRow AddCarRow(string Make, string Model, int Year, string VIN, string Color, long Odometer, decimal Price, string LicensePlate, bool Available) {
        ...
        public partial class CarRow : global::System.Data.DataRow {
            ...
            public long Odometer {
                get {
                    try {
                        return ((long)(this[this.tableCar.OdometerColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace FinalProject.CarsTableAdapters {
    ...
    public partial class CarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Car] WHERE (([LicensePlate] = @Original_LicensePlate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Car] ([Make], [Model], [Year], [VIN], [Color], [Odometer], [Price], " +
                "[LicensePlate], [Available]) VALUES (@Make, @Model, @Year, @VIN, @Color, @Odomet" +
                "er, @Price, @LicensePlate, @Available)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Car] SET [Make] = @Make, [Model] = @Model, [Year] = @Year, [VIN] = @VIN, " +
                "[Color] = @Color, [Odometer] = @Odometer, [Price] = @Price, [LicensePlate] = @Li" +
                "censePlate, [Available] = @Available WHERE (([LicensePlate] = @Original_LicenseP" +
                "late))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Make, Model, Year, VIN, Color, Odometer, Price, LicensePlate, Available\r\nF" +
                "ROM     Car";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Make, Model, Year, VIN, Color, Odometer, Price, LicensePlate, Available\r\nF" +
                "ROM     Car WHERE Available = \'True\'";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Available, Color, LicensePlate, Make, Model, Odometer, Price, VIN, Year FR" +
                "OM Car WHERE (LicensePlate = @plate)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@plate", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "LicensePlate", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "UPDATE [Car] SET [Available] = @Available WHERE (([LicensePlate] = @Original_Lice" +
                "nsePlate))";
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_LicensePlate", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "LicensePlate", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(Cars.CarDataTable dataTable) {
        ...
        public virtual Cars.CarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Cars.CarDataTable dataTable = new Cars.CarDataTable();
        ...
        public virtual int FillByAvailability(Cars.CarDataTable dataTable) {
        ...
        public virtual Cars.CarDataTable GetDataByAvailability() {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            Cars.CarDataTable dataTable = new Cars.CarDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByLic(Cars.CarDataTable dataTable, string plate) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((plate == null)) {
                throw new global::System.ArgumentNullException("plate");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(plate));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual Cars.CarDataTable GetDataBy(string plate) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((plate == null)) {
                throw new global::System.ArgumentNullException("plate");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Cars.CarDataTable dataTable) {
        ...
        public virtual int Delete(string Original_LicensePlate) {
        ...
        public virtual int Insert(string Make, string Model, global::System.Nullable<int> Year, string VIN, string Color, global::System.Nullable<long> Odometer, decimal Price, string LicensePlate, global::System.Nullable<bool> Available) {
            if ((Make == null)) {
            ...
            if ((Odometer.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((long)(Odometer.Value));
            }
            else {
            ...
            if ((LicensePlate == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(LicensePlate));
            }
            if ((Available.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[8].Value = ((bool)(Available.Value));
            }
            else {
        ...
        public virtual int Update(string Make, string Model, global::System.Nullable<int> Year, string VIN, string Color, global::System.Nullable<long> Odometer, decimal Price, string LicensePlate, global::System.Nullable<bool> Available, string Original_LicensePlate) {
            if ((Make == null)) {
                throw new global::System.ArgumentNullException("Make");
            }
            else {
            ...
            if ((Odometer.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((long)(Odometer.Value));
            }
            else {
            ...
            if ((LicensePlate == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(LicensePlate));
            }
            if ((Available.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((bool)(Available.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Make, string Model, global::System.Nullable<int> Year, string VIN, string Color, global::System.Nullable<long> Odometer, decimal Price, global::System.Nullable<bool> Available, string Original_LicensePlate) {
            return this.Update(Make, Model, Year, VIN, Color, Odometer, Price, Original_LicensePlate, Available, Original_LicensePlate);
        }
        ...
        public virtual int UpdateCarAvailability(global::System.Nullable<bool> Available, string Original_LicensePlate) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[3];
            if ((Available.HasValue == true)) {
                command.Parameters[0].Value = ((bool)(Available.Value));
            }
            else {
            ...
            if ((Original_LicensePlate == null)) {
                ...
                command.Parameters[1].Value = ((string)(Original_LicensePlate));
            }
