...
namespace FinalProject {
    ...
    public partial class dsReservation : global::System.Data.DataSet {
        ...
        public partial class ReservationDataTable : global::System.Data.TypedTableBase<ReservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ReservationRow AddReservationRow(int Id, string CarLicensePlate, System.DateTime FromDate, System.DateTime ToDate, string CustomerUsername) {
            ...
            private void InitClass() {
                ...
                this.columnCarLicensePlate.AllowDBNull = false;
        ...
        public partial class ReservationRow : global::System.Data.DataRow {
            ...
            public string CarLicensePlate {
                get {
                    return ((string)(this[this.tableReservation.CarLicensePlateColumn]));
                }
                set {
                    this[this.tableReservation.CarLicensePlateColumn] = value;
                }
            }
            ...
            public System.DateTime FromDate {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'FromDate\' in table \'Reservation\' is DBNull.", e);
                    }
                }
                set {
            ...
            public System.DateTime ToDate {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'ToDate\' in table \'Reservation\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string CustomerUsername {
                get {
                    return ((string)(this[this.tableReservation.CustomerUsernameColumn]));
                }
                set {
                    this[this.tableReservation.CustomerUsernameColumn] = value;
                }
            }
            ...
            public bool IsFromDateNull() {
                return this.IsNull(this.tableReservation.FromDateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetFromDateNull() {
                this[this.tableReservation.FromDateColumn] = global::System.Convert.DBNull;
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bool IsToDateNull() {
                return this.IsNull(this.tableReservation.ToDateColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetToDateNull() {
                this[this.tableReservation.ToDateColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace FinalProject.dsReservationTableAdapters {
    ...
    public partial class ReservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Reservation] WHERE (([Id] = @Original_Id))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Reservation] ([CarLicensePlate], [CustomerUsername], [FromDate], [To" +
                "Date]) VALUES (@CarLicensePlate, @CustomerUsername, @FromDate, @ToDate)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Reservation] SET [CarLicensePlate] = @CarLicensePlate, [CustomerUsername]" +
                " = @CustomerUsername, [FromDate] = @FromDate, [ToDate] = @ToDate WHERE (([Id] = " +
                "@Original_Id))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        Id, CarLicensePlate, CustomerUsername, FromDate, ToDate\r\nFROM      " +
                "      Reservation";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT CarLicensePlate, CustomerUsername, FromDate, Id, ToDate FROM Reservation W" +
                "HERE (Id = @id)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT        Id, CarLicensePlate, CustomerUsername, FromDate, ToDate\r\nFROM      " +
                "      Reservation\r\nWHERE        (CustomerUsername = @username)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@username", global::System.Data.SqlDbType.NVarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerUsername", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillById(dsReservation.ReservationDataTable dataTable, int id) {
        ...
        public virtual dsReservation.ReservationDataTable GetDataById(int id) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(id));
            dsReservation.ReservationDataTable dataTable = new dsReservation.ReservationDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillMyReservations(dsReservation.ReservationDataTable dataTable, string username) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual dsReservation.ReservationDataTable GetDataByReservations(string username) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
        ...
        public virtual int Insert(string CarLicensePlate, string CustomerUsername, global::System.Nullable<global::System.DateTime> FromDate, global::System.Nullable<global::System.DateTime> ToDate) {
            if ((CarLicensePlate == null)) {
                throw new global::System.ArgumentNullException("CarLicensePlate");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(CarLicensePlate));
            }
        ...
        public virtual int Update(string CarLicensePlate, string CustomerUsername, global::System.Nullable<global::System.DateTime> FromDate, global::System.Nullable<global::System.DateTime> ToDate, int Original_Id) {
            if ((CarLicensePlate == null)) {
                throw new global::System.ArgumentNullException("CarLicensePlate");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(CarLicensePlate));
            }
            if ((CustomerUsername == null)) {
                throw new global::System.ArgumentNullException("CustomerUsername");
            }
